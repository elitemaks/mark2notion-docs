...
<ResponseField name="data" type="object">
  <Expandable title="data">
    <ResponseField name="markdown" type="string">
      The Markdown representation of the Notion page content
    </ResponseField>
...
<Info>
Each notion-to-markdown request counts as 1 API call against your quota, regardless of the page size.
</Info>
